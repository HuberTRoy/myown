<template>
    <div class="lucky-draw-wheel" :style="{
        width: `${width}px`,
        height: `${height}px`
    }">
        <!-- 
        ...
        <!-- wrapper是用来做整体的旋转动画 -->
        <div class="lucky-draw-wheel-wrapper" ref="luckyWrapper">

            <div class="lucky-draw-wheel-item" v-for="(prize, index) in prizes" 
                                               :key="index"
        ...
        <div class="lucky-draw-wheel-button" @click="start">
            立即抽奖
...
export default defineComponent({
    ...
    setup(props) {
        ...
        let start = async () => {
            ...
            let result = await props.startFunc()
...
.lucky-draw-wheel-button::before {
    content: ' ';
    height: 50%;
    width: 50%;
    position: absolute;
